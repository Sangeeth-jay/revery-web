    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <button
          ...
          type="button"
          className="focus:outline-none cursor-pointer text-white text-md font-medium bg-red-700 hover:bg-[#FF0303] focus:ring-4 focus:ring-red-300 rounded-sm px-5 py-2.5 me-1.5 dark:bg-red-600  dark:focus:ring-red-900"
        >
          Contact us
        </button>
      </motion.div>
